...
#     queryset = Leader.objects.filter(status='SUCCESS').order_by('name')
#     serializer_class = LeaderSerializer1

# class LeaderPost(generics.GenericAPIView):
...
# class LeaderUpdate(generics.GenericAPIView):
#     serializer_class = LeaderSerializer
    
    
#     def put(self, request, _id):
#         # Retrieve the instance
#         instance = get_object_or_404(Leader, _id=_id)
