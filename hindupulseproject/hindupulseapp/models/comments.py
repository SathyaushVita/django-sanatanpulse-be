...
class CommentModel(models.Model):
    ...
    user = models.ForeignKey(Register, on_delete=models.SET_NULL, related_name='comment_user', null=True, db_column='user')
    articles = models.ForeignKey('ArticleModel', db_column='articles', on_delete=models.CASCADE, max_length=1000, blank=True, null=True)
