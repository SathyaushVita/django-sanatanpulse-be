...
class OutlookCommentModel(models.Model):
    _id = models.CharField(db_column='_id', primary_key=True, max_length=45, default=uuid.uuid1, unique=True, editable=False)
    user = models.ForeignKey(Register, on_delete=models.SET_NULL, related_name='outlook_comment_user', null=True, db_column='user')
    news = models.ForeignKey('NewsSubCategory', db_column='news', on_delete=models.CASCADE, max_length=1000, blank=True, null=True)
